...
![Single plot](/docs/docs/images/single_plot.png)
![Single plot](images/single_plot.png)

* Split plot into multiple subplots if there are more multiple symbols

![Multiple plots](/docs/docs/images/split_plot.png)
![Multiple plots](images/split_plot.png)
...
* Create `release` environment for [GitHub Actions](https://docs.github.com/en/actions/managing-workflow-runs-and-deployments/managing-deployments/managing-environments-for-deployment#creating-an-environment) to enable uploads of the library to PyPi. Set protections on what tags can deploy to this environment (Point 10). Set it to tags following pattern `release/*`.
